...
describe Pagy::Frontend do
  ...
  describe '#pagy_items_selector_js' do
    ...
    it 'renders items selector' do
      ...
      html.must_equal \
      "<span id=\"test-id\"><a href=\"/foo?page=#{Pagy::Frontend::MARKER}-page-&items=#{Pagy::Frontend::MARKER}-items-\" style=\"display: none;\" rel=\"nofollow\"></a>Show <input type=\"number\" min=\"1\" max=\"100\" value=\"20\" style=\"padding: 0; text-align: center; width: 3rem;\"> items per page</span><script type=\"application/json\" class=\"pagy-json\">[\"items_selector\",\"test-id\",\"#{Pagy::Frontend::MARKER}\",41]</script>"
    end
